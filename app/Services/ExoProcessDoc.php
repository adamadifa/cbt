...
class ExoProcessDoc
{
    ...
    public function __construct($template, $filepath, $directory)
    {
        ...
        $this->target_dir = public_path('app/public/'.$directory->slug.'/');
        ...
        $this->new_name_path = public_path('storage/public/'.$directory->slug.'/'.$new_name);
    ...
    private function _strip_tag_images($xml)
    {
        ...
        foreach ($relation_image as $key => $value) {
            ...
            $img = '<img src="'.$this->dsn.'/storage/public/'.$this->directory->slug.'/'.$imagenew_name.'.webp">';;
